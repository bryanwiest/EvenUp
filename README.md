...
The graphical interface provides an intuitive way to manage your expenses and groups.

**Main View** - Overview of all your groups with quick navigation:

<img src="src/main/resources/images/home.png" alt="Main View" width="600">

**Group View** - Manage members, view expenses, and calculate debts:

<img src="src/main/resources/images/group.png" alt="Group View" width="600">

**Expense View** - Add and track shared expenses with custom share distribution:

<img src="src/main/resources/images/expense.png" alt="Expense View" width="600">
